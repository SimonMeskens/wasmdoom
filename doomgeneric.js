...
var ASM_CONSTS = {
  224704: ($0) => { const canvas = Module.canvas; const context = Module.context; if (!Module.imageData) Module.imageData = new ImageData( new Uint8ClampedArray( Module.asm.memory.buffer, $0, canvas.width * canvas.height * 4 ), canvas.width, canvas.height ); context.putImageData(Module.imageData, 0, 0); }
};
...
/** @type {function(...*):?} */
var _doomgeneric_AddKey = Module["_doomgeneric_AddKey"] = createExportWrapper("doomgeneric_AddKey");
/** @type {function(...*):?} */
